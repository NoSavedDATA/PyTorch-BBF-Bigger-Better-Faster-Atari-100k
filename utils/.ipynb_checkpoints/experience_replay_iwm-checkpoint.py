...
from nosaveddata.nsd_preprocessing.vision import preprocess_iwm_stacked
...
class PrioritizedReplay_nSteps_Sqrt(object):
    ...
    def sample(self, seq_len, batch_size, step):
        ...
        states_iwm, iwm_augments = preprocess_iwm_stacked(preprocess_replay(states[:,0].unsqueeze(1)).clone().squeeze(), stacks=4)
        ...
        return states, next_states, states_iwm, iwm_augments, rewards, action, c_flag, idxs, is_ws#, self.priority[idxs]
